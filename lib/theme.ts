...
export const componentTokens = {
  button: {
    ...
    ghost: "text-neutral-text-secondary hover:text-white hover:bg-slate-800 rounded-xl",
    outline: "border border-neutral-border text-neutral-text-primary hover:bg-slate-800",
  ...
  card: {
    ...
    hover: "hover:-translate-y-0.5 hover:shadow-card transition-all duration-200",
    stat: "bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col gap-2",
    analytics: "bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-card",
  },
  badge: {
  ...
  builder: {
    ...
    inspector: "w-80 border-l border-slate-800 bg-slate-950/95 p-4 flex flex-col",
