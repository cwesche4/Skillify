    ...
    <div className="px-6 pb-28 pt-24">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-4 text-sm text-zinc-600 dark:text-zinc-400 sm:text-base">
          Skillify is designed to be powerful enough for agencies but simple enough for
          solo operators. This page walks you through the first setup steps so you can
          ship value in under an hour.
        </p>
        ...
        <div className="mt-10 rounded-2xl border border-zinc-200 bg-zinc-50 p-6 text-sm text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/80 dark:text-zinc-300">
          ...
          <p>
            Under the hood, Skillify works with a multi-workspace model. Each workspace
            can have members, automations, runs, and subscriptions. Once your dashboard is
            wired to Prisma, you can use these models to power:
          </p>
          ...
          <p className="mt-3">
            When you’re ready, you can add billing on top (Stripe or another provider) to
