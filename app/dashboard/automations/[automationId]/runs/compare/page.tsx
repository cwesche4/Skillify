              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {diff.map((row, i) => (
                    <tr
                      key={i}
                      className={row.changed ? "bg-slate-900/40" : "bg-slate-900/10"}
                    >
    ...
    <div className="mt-4 space-y-2">
      <div className="flex items-center gap-2 text-xs">
        ...
        <div className="h-2 flex-1 rounded bg-slate-800">
          <div className="h-2 rounded bg-blue-500/70" style={{ width: `${aPct}%` }} />
        </div>
      ...
      <div className="flex items-center gap-2 text-xs">
        ...
        <div className="h-2 flex-1 rounded bg-slate-800">
          <div className="h-2 rounded bg-green-500/70" style={{ width: `${bPct}%` }} />
        </div>
