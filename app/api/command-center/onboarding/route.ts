...
import type { OnboardingItem, OnboardingResponse } from "@/lib/command-center/types"
...
export async function GET(req: Request) {
  ...
  const checklist: OnboardingItem[] = [
    ...
    },
    {
      ...
      description: "Trigger a test run so Skillify can start learning your patterns.",
      completed: hasRun,
      href: "/dashboard/automations",
      priority: "high",
    },
    {
      ...
      description: "Share your workspace and collaborate on flows and analytics.",
    ...
    },
    {
      ...
      description: "Check success rate, failure hotspots, and cost trends for your runs.",
      completed: hasRun,
